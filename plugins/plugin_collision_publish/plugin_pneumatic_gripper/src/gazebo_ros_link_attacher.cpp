...
#include <ros/ros.h>
#include "plugin_pneumatic_gripper.h"
#include "plugin_pneumatic_gripper/Attach.h"
...
namespace gazebo
{
  ...
  bool GazeboRosLinkAttacher::attach_callback(plugin_pneumatic_gripper::Attach::Request &req,
                                              plugin_pneumatic_gripper::Attach::Response &res)
  {
  ...
  bool GazeboRosLinkAttacher::detach_callback(plugin_pneumatic_gripper::Attach::Request &req,
                                              plugin_pneumatic_gripper::Attach::Response &res){
