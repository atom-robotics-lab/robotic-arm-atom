...
#ifndef plugin_pneumatic_gripper_HH
#define plugin_pneumatic_gripper_HH
...
namespace gazebo
{
   ...
   private:
        ...
        bool attach_callback(plugin_pneumatic_gripper::Attach::Request &req,
                              plugin_pneumatic_gripper::Attach::Response &res);
        bool detach_callback(plugin_pneumatic_gripper::Attach::Request &req,
                             plugin_pneumatic_gripper::Attach::Response &res);
